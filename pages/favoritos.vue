		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
			...
			<div v-if="!hasFavorites"
				...
				<div class="flex flex-col items-center">
					...
					<NuxtLink class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gray-500 hover:bg-gray-600"
							  to="/">
						Ver productos
					</NuxtLink>
				</div>
			...
			<div v-else>
				...
				<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
					...
					>
						...
						>
							<svg class="h-5 w-5 text-red-500 fill-current"
								 stroke="currentColor"
								 viewBox="0 0 24 24"
								 xmlns="http://www.w3.org/2000/svg">
								<path d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"
