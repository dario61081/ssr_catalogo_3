  ...
  <div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="space-y-6">
          <div>
            <h3 class="font-medium text-gray-900 mb-2">Showroom Encarnación</h3>
            <p class="text-gray-600 flex items-start">
              <svg class="h-5 w-5 mr-2 text-gray-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            <h3 class="font-medium text-gray-900 mb-2">Showroom Asunción</h3>
            <p class="text-gray-600 flex items-start">
              <svg class="h-5 w-5 mr-2 text-gray-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"
                      stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
          ...
          <div>
            <h3 class="font-medium text-gray-900 mb-2">Correo Electrónico</h3>
            <p class="text-gray-600 flex items-start">
              <svg class="h-5 w-5 mr-2 text-gray-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"
                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
              </svg>
              info@paranahogar.com.py
            </p>
          </div>
          ...
          <div class="pt-4 border-t border-gray-200">
            <h3 class="font-medium text-gray-900 mb-3">Síguenos en Redes Sociales</h3>
      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <form class="space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700" for="mensaje">Mensaje</label>
            <textarea
              id="mensaje"
              rows="4"
              class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          ...
          <button type="submit" class="w-full py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-500 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            Enviar Mensaje
          </button>
        </form>
      </div>
