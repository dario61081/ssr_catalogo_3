<template>
	<div class="favorites-page">
		<div class="container mx-auto max-w-6xl px-4 py-6">
			<!-- Breadcrumb -->
			<BreadCrumb :items="[{ text: 'Favoritos' }]"
				class="mb-6"/>
				...
				<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
					...
					>
						...
						<div class="p-4">
							...
							<NuxtLink :to="`/product/${product.codigo}`"
								class="block">
								<h3 class="text-sm font-medium text-gray-900 mb-1 line-clamp-2 min-h-[40px] hover:text-gray-600 overflow-hidden">
									{{ product.nombre }}
								</h3>
							</NuxtLink>
...
useHead({
	...
	meta: [
		{
			name: 'description',
			content: 'Gestiona tus productos favoritos de Paraná Hogar. Añade productos a tu carrito o elimínalos de tu lista de favoritos.'
		}
	]
});
