		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			<div class="lg:hidden space-y-1">
				...
				<div class="border-b border-gray-800 py-2 mb-2">
					...
					<div v-show="openSections.service"
						class="mt-4 space-y-3 text-gray-400">
						<div>
							<a class="hover:text-white"
								href="/info/contacto">Contacto
							</a>
						</div>
						<div>
							<a class="hover:text-white"
								href="/info/faq">Preguntas Frecuentes
							</a>
						</div>
						...
						<div>
							<a class="hover:text-white"
								href="/info/terminos">Términos y Condiciones
							</a>
						</div>
					</div>
				</div>
			...
			<div class="mt-4 pt-4 border-t border-gray-800">
				<div class="flex flex-col md:flex-row md:justify-between md:items-center">
					...
					<div class="flex flex-wrap gap-3 text-xs text-gray-400">
						...
						<a class="hover:text-white"
							href="/info/terminos">Términos de Uso
						</a>
						<a class="hover:text-white"
							href="/info/cookies">Política de Cookies
						</a>
					</div>
				</div>
			</div>
