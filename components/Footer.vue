  ...
  <footer class="bg-gray-900 text-white pt-8 pb-6">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="hidden lg:grid lg:grid-cols-4 lg:gap-8">
        <!-- Company Info -->
        <div>
          <img alt="Parana Hogar" src="/img/logo_white.svg" style="width: 200px; margin-bottom: 1rem;">
      ...
      <div class="mt-8 pt-8 border-t border-gray-800">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
          ...
          <div class="flex flex-wrap gap-4 text-sm text-gray-400">
            <a class="hover:text-white" href="/privacidad">Política de Privacidad</a>
            <a class="hover:text-white" href="/terminos-uso">Términos de Uso</a>
            <a class="hover:text-white" href="/cookies">Política de Cookies</a>
          </div>
        </div>
      </div>
    </div>
