  ...
  <footer class="bg-gray-900 text-white pt-8 pb-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="lg:hidden">
        ...
        <div class="border-b border-gray-800 pb-4 mb-4">
          <div class="flex items-center justify-between" @click="toggleSection('company')">
            ...
            <svg 
              ...
              :class="openSections.company ? 'rotate-180' : ''"
              fill="none" 
              viewBox="0 0 24 24" 
              stroke="currentColor"
            >
          ...
          <div v-show="openSections.company" class="mt-4 space-y-3 text-gray-400">
        ...
        <div class="border-b border-gray-800 py-4 mb-4">
          ...
          <div v-show="openSections.links" class="mt-4 space-y-3 text-gray-400">
            <div><a href="/" class="hover:text-white">Inicio</a></div>
            <div><a href="/productos" class="hover:text-white">Productos</a></div>
            <div><a href="/categorias" class="hover:text-white">Categorías</a></div>
            <div><a href="/ofertas" class="hover:text-white">Ofertas</a></div>
          </div>
        </div>
        ...
        <div class="border-b border-gray-800 py-4 mb-4">
          ...
          <div v-show="openSections.service" class="mt-4 space-y-3 text-gray-400">
            <div><a href="/contacto" class="hover:text-white">Contacto</a></div>
            <div><a href="/faq" class="hover:text-white">Preguntas Frecuentes</a></div>
            <div><a href="/envios" class="hover:text-white">Envíos</a></div>
            <div><a href="/devoluciones" class="hover:text-white">Devoluciones</a></div>
            <div><a href="/terminos" class="hover:text-white">Términos y Condiciones</a></div>
          </div>
        </div>
        ...
        <div class="border-b border-gray-800 py-4 mb-4">
          ...
          <div v-show="openSections.contact" class="mt-4 space-y-3 text-gray-400">
      ...
      <div class="hidden lg:grid lg:grid-cols-4 lg:gap-8">
        <!-- Company Info -->
        <div>
          <h3 class="text-lg font-semibold mb-4">Paraná Hogar</h3>
        ...
        <div>
          ...
          <ul class="space-y-3 text-gray-400">
            ...
            <li><a href="/ofertas" class="hover:text-white">Ofertas</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-3 text-gray-400">
            ...
            <li><a href="/envios" class="hover:text-white">Envíos</a></li>
            <li><a href="/devoluciones" class="hover:text-white">Devoluciones</a></li>
      ...
      <div class="mt-8 pt-8 border-t border-gray-800">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
          ...
          <div class="flex flex-wrap gap-4 text-sm text-gray-400">
            ...
            <a href="/terminos-uso" class="hover:text-white">Términos de Uso</a>
