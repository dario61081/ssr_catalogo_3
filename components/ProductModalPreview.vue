  ...
  setup(props, { emit }) {
    ...
    const loadProduct = async (id: string) => {
      ...
      try {
        ...
        product.value = await productoStore.getProductById(id);
      } catch (err) {
...
<template>
  <div class="product-modal-overlay" v-if="isOpen" @click.self="closeModal">
    <div class="product-modal-container">
      ...
      <div class="product-modal-footer">
        <button class="product-modal-button secondary" @click="closeModal">Cerrar</button>
