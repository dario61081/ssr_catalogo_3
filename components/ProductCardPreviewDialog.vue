                ...
                : 'bg-gray-300 cursor-not-allowed'
					...
					<div class="mt-6 flex flex-wrap gap-2">
						<div class="flex items-center">
							<span class="text-sm text-gray-700 mr-2">18 x Gs. {{
									formatPrice(Math.round(product?.precio / 18))
								}}</span>
					...
					<div class="mt-8 border-t border-gray-200">
						<div class="border-b border-gray-200">
							<button class="flex w-full justify-between items-center py-4 text-left"
								@click="toggleSection('envios')">
							...
							<div v-show="openSections.envios"
								class="pb-4 text-sm text-gray-700">
								<p>Realizamos envíos a todo el país. El costo y tiempo de entrega varía según la
									ubicación.</p>
							</div>
						</div>
						...
						<div class="border-b border-gray-200">
							...
							<div v-show="openSections.garantia"
								class="pb-4 text-sm text-gray-700">
