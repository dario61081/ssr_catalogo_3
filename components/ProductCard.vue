<template>
  <div
    ...
    <div class="flex-1 p-4 flex flex-col">
      ...
      <div class="mt-auto">
        <p class="text-base sm:text-lg font-bold text-gray-900">Gs. {{ formatPrice(product.precio) }}</p>
        <button
            class="mt-3 w-full bg-gray-500 hover:bg-gray-600 text-white text-sm py-2 px-3 rounded-md flex items-center justify-center transition-colors duration-200">
