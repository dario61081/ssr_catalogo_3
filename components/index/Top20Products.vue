	...
	<div class="w-full overflow-hidden h-[400px]">
		...
		<div v-else>
			<div class="relative overflow-hidden">
				<!-- Botón Izquierda -->
				<button class="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-gray-800/70 hover:bg-gray-700/90 text-white rounded-full w-8 h-8 flex items-center justify-center shadow transition"
					@click="scrollLeft">
				...
				<!-- Botón Derecha -->
				<button class="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-gray-800/70 hover:bg-gray-700/90 text-white rounded-full w-8 h-8 flex items-center justify-center shadow transition"
					@click="scrollRight">
