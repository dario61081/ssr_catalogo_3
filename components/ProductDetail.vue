<template>
  <div class="product-detail">
    ...
    <div v-else-if="error" class="text-center py-16">
      ...
      <NuxtLink to="/catalog" class="mt-4 inline-block bg-gray-700 hover:bg-gray-800 text-white py-2 px-4 rounded transition-colors">
        Volver al catálogo
      </NuxtLink>
    </div>
    ...
    <div v-else-if="product" class="bg-white rounded-lg shadow-sm overflow-hidden">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
        ...
        <div class="product-info">
          <div class="mb-4">
            <p class="text-sm text-gray-500 mb-1">{{ product.desc_division }} > {{ product.desc_categoria }}</p>
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="flex">
              ...
              <div class="w-2/3 text-gray-600">{{ product.stock > 0 ? 'En stock' : 'Sin stock' }}</div>
            </div>
          </div>
        </div>
      </div>
